...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if(current==0)
        {
            ...
            jb[0].setText("charles Babbage");jb[1].setText("James Gosling");jb[2].setText("Bjarne Stroustrup");jb[3].setText("Blais Pascal");
        }
        if(current==1)
        {
            l.setText("Que2: Which component is used to compile,debug and execute the java programs?");
            jb[0].setText("6");jb[1].setText("JRE");jb[2].setText("JDK");jb[3].setText("JVM");
        }
        if(current==2)
        {
        ...
        if(current==3)
        {
            l.setText("Que4: What is extension of java code files?");
